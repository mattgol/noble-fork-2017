...
function Noble(bindings) {
  ...
  // Default settings for noble
  this._settings['scanmode'] = 'active';
}
...
Noble.prototype.setScanMode = function(scanMode) {
  this._settings.scanmode = scanMode;
};
...
Noble.prototype.startScanning = function(serviceUuids, allowDuplicates, callback) {
  if (this.state !== 'poweredOn') {
    ...
    this._bindings.startScanning(serviceUuids, allowDuplicates,this._settings['scanmode']);
  }
};
...
Noble.prototype.onCharacteristicsDiscover = function(peripheralUuid, serviceUuid, characteristics) {
  var service = this._services[peripheralUuid][serviceUuid];
  //var service = this._bindings._gattStructures[peripheralUuid].services[serviceUuid];
