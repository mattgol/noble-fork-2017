...
Gap.prototype.startScanning = function(allowDuplicates,scanMode) {
  this._scanState = 'starting';
  this._scanFilterDuplicates = !allowDuplicates;
  this._scanMode = scanMode;

  this._hci.setScanEnabled(true, this._scanFilterDuplicates, this._scanMode);
};
...
Gap.prototype.onHciLeAdvertisingReport = function(status, type, address, addressType, eir, rssi) {
  ...
  if (type === 0x04 || this._scanMode=='passive' || (discoveryCount > 1 && !hasScanResponse) || process.env.NOBLE_REPORT_ALL_HCI_EVENTS) {
