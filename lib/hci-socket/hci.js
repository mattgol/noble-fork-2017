...
Hci.prototype.setScanParameters = function(scanMode) {
  ...
  // data
  if(scanMode!=undefined && scanMode==='active') {
...
Hci.prototype.setScanEnabled = function(enabled, filterDuplicates, scanMode) {
  var cmd = new Buffer(6);
  
  // call set scan parameters again
  this.setScanParameters(scanMode);
