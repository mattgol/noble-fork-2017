...
NobleBindings.prototype.startScanning = function(serviceUuids, allowDuplicates, scanMode) {
  this._scanServiceUuids = serviceUuids || [];

  this._gap.startScanning(allowDuplicates,scanMode);
};
...
NobleBindings.prototype.onDisconnComplete = function(handle, reason) {
  ...
  if (uuid) {
    ...
    this._gattStructures[uuid].cleanup();
